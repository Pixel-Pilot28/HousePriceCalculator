...
def simulate_scenario(price, mortgage_rate, term, investment_return, housing_return, duration, mode):
    ...
    if mode == 'cash':
        ...
        remaining_investments = 4_000_000 - stock_sale_needed
        ...
        down_payment_tax = down_payment_sale * capital_gains_tax
        ...
        invested_balance = future_value(4_000_000 - down_payment_sale, investment_return, duration)
        ...
        tax_cost = total_stock_sale * capital_gains_tax
        ...
        # Investments grow
        invested_balance = future_value(4_000_000 - total_stock_sale, investment_return, duration)
