...
class HouseCalculatorGUI:
    ...
    def simulate_scenario(self, price, down_payment, mortgage_rate, term, investment_return, 
        ...
        if mode == 'cash':
            ...
            invested_balance = self.future_value(initial_investment - stock_sale_needed, investment_return, duration)
            ...
            payment = self.mortgage_payment(principal, mortgage_rate, term)
            ...
            invested_balance = self.future_value(initial_investment, investment_return, duration)
            home_value = price * ((1 + housing_return) ** duration)
